...
public class Menu extends JFrame {
    private Tower_Defense.Main.Button[] arrayBtn = new Tower_Defense.Main.Button[5];
...
//    MP3Player player = new MP3Player(file1);
    ...
    public Menu() {
        ...
        arrayBtn[0] = new Tower_Defense.Main.Button(400, 400, 200, 35, button1);
        arrayBtn[1] = new Button(400, 450, 200, 35, button2);
