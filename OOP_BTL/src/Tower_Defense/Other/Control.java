...
//                e.getY() - ((Frame.size.height - (Screen.myHeight))- (Frame.size.width-Screen.myWidth)/2));
    ...
    public void mouseDragged(MouseEvent e) {
        MainGame.mse = new Point(e.getX() - (Tower_Defense.Main.Menu.size.width - MainGame.myWidth) / 2,
                e.getY() - ((Tower_Defense.Main.Menu.size.height - (MainGame.myHeight))- (Tower_Defense.Main.Menu.size.width- MainGame.myWidth)/2));
    }
    ...
    public void mouseMoved(MouseEvent e) {
        MainGame.mse = new Point(e.getX() - (Tower_Defense.Main.Menu.size.width - MainGame.myWidth) / 2,
                e.getY() - ((Tower_Defense.Main.Menu.size.height - (MainGame.myHeight)) - (Menu.size.width- MainGame.myWidth)/2));
    }
}
